...
<main>
  <p class="font-serif text-base text-left mt-12">
    ...
    where I build software at Meta. Previously, I have lived in Los Angeles (university - fight on!), 
    San Jose (hometown), and Shanghai (until I was ~5).
  </p>

  <section class="mt-8">
    <h2 class="font-serif text-2xl font-semibold text-left">Find me here</h2>
